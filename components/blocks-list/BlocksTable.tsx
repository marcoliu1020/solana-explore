            ...
            <tr key={block.blockNumber} className="border-b border-gray-800/50 bg-gray-900/30 hover:bg-gray-900/50">
              <td className="p-4">
                <div className="flex items-center gap-2">
                  <span className="cursor-pointer text-indigo-400 hover:text-indigo-300">{block.blockNumber}</span>
                  <Copy className="h-4 w-4 cursor-pointer text-gray-500 hover:text-gray-300" />
                </div>
              </td>
              <td className="p-4">
                <div className="flex items-center gap-2">
                  <span className="max-w-[8rem] overflow-hidden text-ellipsis text-indigo-400">{block.hash}</span>
                  <Copy className="h-4 w-4 cursor-pointer text-gray-500 hover:text-gray-300" />
                </div>
              </td>
              <td className="p-4">
              ...
              <td className="p-4">
                <div className="flex items-center gap-2">
                  <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gray-700 text-xs">V</div>
                  <span className="max-w-[8rem] overflow-hidden text-ellipsis text-indigo-400">{block.validator}</span>
                  <Copy className="h-4 w-4 cursor-pointer text-gray-500 hover:text-gray-300" />
                </div>
              </td>
